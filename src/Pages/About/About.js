    ...
    <div className="container mx-auto">
      <div className="about">
        ...
        <div className="text-start">
          <p>
            আমার এউমাত্র লক্ষই হলো একজন ভালো মানের Web Developer হিসেবে নিজেকে
            গড়ে তোলা। আমি ২০২২ সালের মধ্যেই নিজেকে একজন Full Stack Web Developer
            হিসেবে তৈরি করতে চাই।
          </p>
          <p>
            লক্ষে পৌঁছানোর জন্য আমাকে দৈনিক ১৮ ঘন্টা কাজ করা লাগলেও অমা তা করতে
            রাজি আমি জানি আমি আমার লক্ষে পৌঁছানোর জন্য এতটুকু Effort করার
            সক্ষমতা রাখি।
          </p>
          <p>
